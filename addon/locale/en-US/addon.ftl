...
popupRoot-PanelConfig =  面板配置
popupRoot-FixedPanel =  固定面板
popupRoot-PopupPanel =  弹出面板
popupRoot-ColorsPanel =  颜色栏
popupRoot-TagsStyle =  标签样式
